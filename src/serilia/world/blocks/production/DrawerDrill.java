...
public class DrawerDrill extends Block{
    ...
    public float updateEffectChance = 0f;
    ...
    public void setBars(){
        ...
        addBar("drillspeed", (DrawerDrillBuild e) ->
    ...
    public class DrawerDrillBuild extends Building{
