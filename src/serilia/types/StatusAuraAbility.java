...
public class StatusAuraAbility extends Ability {
    ...
    public float statusDuration = 60f * 5f;
    public float x, y;
    public boolean targetGround = true, targetAir = true, hitUnits = true;
    public int maxTargets = 20;
    public float layer = Layer.bullet - 0.001f, blinkScl = 20f, blinkSize = 0.1f;
    public float effectRadius = 4f, sectorRad = 0.10f, rotateSpeed = 0.7f;
    ...
    StatusAuraAbility(){}
    public StatusAuraAbility(float reload, float range){
        this.reload = reload;
        this.range = range;
    }
    @Override
    public String localized(){
        return Core.bundle.format("ability.energyfield", range / Vars.tilesize, maxTargets);
    }
